...
<html>
    ...
    <body>        
        ...
        <ul id="slide-out" class="sidenav ">
            ...
            <li><a href="<?=HOME_URL?>/Dashboard/Admin/Perfil">Perfil<i class="material-icons">assignment_ind</i></a></li>
                ...
                <ul class=" collapsible collapsible-accordion  ">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Evento">Eventos<i class="material-icons">event</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/NovasSolicitacoes" class="">Novas solicitações<i class="material-icons">assignment_late</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/SolicitacoesAvaliadas">Solicitações avaliadas<i class="material-icons">new_releases</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Resultados">Resultados<i class="material-icons">event_note</i></a></li>
                                <li><div class="divider"></div></li>
            ...
            <li class="no-padding blue darken " >
                <ul class=" collapsible collapsible-accordion ">
                    <li>
                        ...
                        <div class="collapsible-body ">
                            <ul>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Cursos">Cursos<i class="material-icons">collections_bookmark</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Materias">Materias<i class="material-icons">layers</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Usuarios">Usuários<i class="material-icons">person</i></a></li>
                                <li><a href="<?=HOME_URL?>/Dashboard/Admin/Noticias">Notícias<i class="material-icons">note</i></a></li>               
                                <li><div class="divider"></div></li>
