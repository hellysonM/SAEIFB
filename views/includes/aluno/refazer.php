...
$aluno->checkSolicitacaoRefazer(4,3);
...
<div class="row">
    <div class="col xl6 offset-xl3 s12 ">
        <div class="card-panel z-depth-2 ">
            ...
            <h5>Refazer Aproveitamento de Estudos</h5>
            ...
            <form action="/Aluno/Refazer/<?=URL[3]?>/<?=URL[4]?>" id="refazer_solicitacao" method="POST" enctype="multipart/form-data" class="">  
                <div class="row">
                    <div class="divider"></div>
