...
<body> 
    ...
    <nav class="teal darken-1">
        <div class="nav-wrapper teal darken-3 " id="menu">
            <a href="#" class="brand-logo">&nbsp;&nbsp;SAE-IFB 0.9.2-alpha</a>                
                    ...
                    <ul class="slides">
                        ...
                        <img src="" class='teal lighten-2 responsive-img'> 
                            <div class="caption center-align">
                              <h3>SAE-IFB</h3>
                              <h5 class="light teal-text text-darken-2">Um novo sistema.</h5>
                            </div>
                        </li>
                        <li>
                        <img src="" class='teal lighten-2'> 
                            <div class="caption left-align">
                              <h3>Automatizando o IFB</h3>
                              <h5 class="light teal-text text-darken-2">IFB automatizado, garantindo maior comodidade aos alunos e servidores do Instituto Federal de Brasília.</h5>
                            </div>
                        </li>
                        <li>
                        <img src="" class='teal lighten-2'> 
                            <div class="caption right-align">
                              <h3>Sistema de Aproveitamento de Estudos</h3>
                              <h5 class="light teal-text text-darken-2">Um novo Sistema, novas novidades, novas facilidades.</h5>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row ">
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center black-text"><i class="material-icons medium ">file_upload</i></h2>
                            <h5 class="center">Envie seus documentos</h5>
                            <p class="light">Com o SAE-IFB, o aluno pode enviar seus documentos de qualquer lugar, evitando deslocamentos até o campus e maior comodidade.
                            </p>
                        </div>
                    </div>
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center black-text"><i class="material-icons medium">dvr</i></h2>
                            <h5 class="center">Acompanhe seu processo</h5>
                            <p class="light">O aluno acompanha em tempo real o envio e avaliação e recebe em tempo real as atualizações de sua solicitação.</p>
                        </div>
                    </div>
                    <div class="col s12 m4">
                        <div class="icon-block">
                            <h2 class="center black-text"><i class="material-icons medium">done</i></h2>
                            <h5 class="center">Receba o resultado</h5>
                            <p class="light">Após a análise, o aluno receberá o resultado de sua solicitação de forma automazida e online. Diretamente pelo site do SAE.</p>
                        </div>
                    </div>
                </div>
            </div>
